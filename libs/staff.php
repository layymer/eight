...
abstract class Staff
{
	...
	public static function makeNameUrlFromDn($DN, $Title="")
		...
		if($GLOBALS['USE_DISPLAY_NAME'])
			{
			$DN=preg_replace("/([ёA-zA-я-]+)[\s]{1}([ёA-zA-я-]+[\s]{1}[ёA-zA-я-]+)(CN.*)/", "<a href=\"newwin.php?menu_marker=si_employeeview&dn=\\3\" data-lightview-type=\"iframe\" data-lightview-options=\"width: '80%', height: '100%', keyboard: {esc: true}, skin: 'light'\" class=\"lightview in_link\"><div class='surname'>\\1</div>\\2</a>", $Title.$DN);
